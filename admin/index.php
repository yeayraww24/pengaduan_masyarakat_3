<?php 
 ...
 ?>
  ...
  <html>
    ...
    <body style="background:url(../img/kedua2.); background-size: cover;">
          ...
          <ul id="slide-out" class="sidenav sidenav-fixed">
              <li>
                  <div class="user-view">
                      ...
                      <a href="#name"><span class="blue-text name"><?php echo ucwords($_SESSION['data']['nama_petugas']); ?></span></a> | by <a href='https://Zata Dira A/' title='StokCoding.com' target='_blank'>Zata Dira A</a>
